	...
	<div class="col-sm-4 col-sm-offset-4">
		<form method="post">
			<div class="form-group">
				<label for="login">Login FAB</label>
				<div class="input-group">
					<span class="input-group-addon"><span
						...
						required="required" placeholder="Usuario do portal do militar"
						pattern=".{11}" data-mask="00000000000" autofocus />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="input-group">
					<span class="input-group-addon"><span
						...
						required="required" placeholder="Senha do portal do militar"
						pattern=".{1,}" />
				</div>
			</div>
